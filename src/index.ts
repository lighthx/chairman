...
export async function searchJDGoods(params: SearchGoodsParams): Promise<any> {
  ...
  try {
    ...
    // 自动更新 Cookie（如果服务器返回了新的）
    cookieManager.updateFromResponseHeaders(response.headers);
